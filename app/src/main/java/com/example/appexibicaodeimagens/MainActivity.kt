...
class MainActivity : AppCompatActivity() {
        ...
        nextButton.setOnClickListener{
            ...
            if(!URLUtil.isValidUrl(url)){
                ...
                Glide.with(this).load(url)
                    ...
                    .into(imageView)
                showSnackbar(main, "No image found")
            }else{
                Glide.with(this).load(url)
    ...
    private fun showSnackbar(main: View, message: String){
        val snackBarView = Snackbar.make(main, message , Snackbar.LENGTH_SHORT)
    ...
    override fun onStart() {
        super.onStart()
        Log.d("TESTE", "Passando por: OnStart")
    }

    override fun onResume() {
        super.onResume()
        Log.d("TESTE", "Passando por: OnResume")
    }

    override fun onPause() {
        super.onPause()
        Log.d("TESTE", "Passando por: OnPause")
    }

    override fun onStop() {
        super.onStop()
        Log.d("TESTE", "Passando por: OnStop")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d("TESTE", "Passando por: OnDestroy")
    }
